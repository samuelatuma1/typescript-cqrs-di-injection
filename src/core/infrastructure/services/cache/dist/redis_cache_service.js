...
var RedisCache = /** @class */ (function () {
    function RedisCache(config) {
        ...
        this.addAsync = function (key, value, durationInSeconds) { return __awaiter(_this, void 0, Promise, function () {
            var redisConnection, valueAsJson, response, ex_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        redisConnection = _a.sent();
                        valueAsJson = serialization_utility_1["default"].serializeJson(value);
                        response = redisConnection.set(key, valueAsJson, { EX: durationInSeconds });
        ...
        this.getAsync = function (key) { return __awaiter(_this, void 0, Promise, function () {
            var redisConnection, json, ex_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        redisConnection = _a.sent();
                        return [4 /*yield*/, redisConnection.get(key)];
                    case 2:
                        json = _a.sent();
                        return [2 /*return*/, serialization_utility_1["default"].deserializeJson(json)];
                    case 3:
                        ex_2 = _a.sent();
                        console.log(ex_2);
        ...
        try {
            var redis = redis_1.createClient({ url: this.config.REDIS_URL });
