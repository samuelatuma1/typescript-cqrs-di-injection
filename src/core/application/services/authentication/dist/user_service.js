...
var create_permission_response_dto_1 = require("../../../domain/common/dto/responses/create_permission_response_dto");
...
var user_permission_1 = require("../../../domain/authentication/user_permission");
var event_tracer_1 = require("../../contract/observability/event_tracer");
var UserService = /** @class */ (function () {
    function UserService(permissionRepository, eventTracer) {
        var _this = this;
    ...
    UserService = __decorate([
        ...
        __param(0, tsyringe_1.inject(permission_repository_1.IIUserPermissionRepository)), __param(1, tsyringe_1.inject(event_tracer_1.IIEventTracer))
    ], UserService);
    return UserService;
}());
