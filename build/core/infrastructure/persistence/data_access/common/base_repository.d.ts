...
export declare class BaseRepository<TEntity extends BaseEntity<TId>, TId> implements IBaseRepository<TEntity, TId> {
    ...
    addAndRemoveFromFieldsList: (query: Partial<{ [k in keyof TEntity]: any; }>, addToFields: Partial<{ [key in keyof TEntity]: any[]; }>, removeFromField: Partial<{ [key_1 in keyof TEntity]: any[] | {
        [key: string]: any;
    }; }>) => Promise<number>;
