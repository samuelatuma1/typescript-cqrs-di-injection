...
let AddressService = class AddressService {
    ...
    getOrCreateAddress = async (address) => {
        if (address instanceof mongoose_1.Types.ObjectId || typeof (address) === 'string') {
        ...
        let cityQuery = city;
        let savedCity;
        if (city instanceof mongoose_1.Types.ObjectId) {
            savedCity = await this.cityRepository.getByIdAsync(new mongoose_1.Types.ObjectId(city));
            if (!savedCity) {
