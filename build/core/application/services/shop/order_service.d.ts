...
export default class OrderService implements IOrderService {
    ...
    constructor(eventTracer: IEventTracer, userService: IUserService, cartRepository: ICartRepository, orderRepository: IOrderRepository, productService: IProductService);
