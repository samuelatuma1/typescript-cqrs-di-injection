...
let OrderServiceProducer = class OrderServiceProducer {
    eventService;
    constructor(eventService) {
        this.eventService = eventService;
    }
    publishNewOrderCreatedEvent = async (orderPlacedDTO) => {
        const configForNewOrder = event_names_config_1.default.getConfigForNewOrderCreated();
...
//# sourceMappingURL=order_service_producer.js.map