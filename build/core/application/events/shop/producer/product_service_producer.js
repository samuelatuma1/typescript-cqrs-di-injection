...
let ProductServiceProducer = class ProductServiceProducer {
    eventService;
    constructor(eventService) {
        this.eventService = eventService;
    }
    publishReviewCreated = async (reviewCreatedEventDTO) => {
        let reviewQueueConfig = event_names_config_1.default.getConfigForNewReviewCreated();
...
//# sourceMappingURL=product_service_producer.js.map